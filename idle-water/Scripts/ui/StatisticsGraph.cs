...
public partial class StatisticsGraph : Control
{
	...
	private const float SecondGraphMarginBottom = 50.0f;
	...
	private void DrawExistingGraph()
	{
		...
		// Value is intentionally on the right side of the graph.
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.End.X + 8.0f, graphRect.Position.Y + graphRect.Size.Y * 0.5f), ExistingGraphYAxis, HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, new Color(0.75f, 0.75f, 0.75f));
	...
	private void DrawTopTimeLabels(Rect2 graphRect)
	{
		...
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.Position.X + graphRect.Size.X * 0.5f - 10.0f, graphRect.End.Y + 14.0f), FormatSeconds(totalSeconds * 0.5f), HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, textColor);
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.End.X - 30.0f, graphRect.End.Y + 14.0f), FormatSeconds(totalSeconds), HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, textColor);
	}
	...
	private void DrawRainEnergyGraph()
	{
		...
		// Energy is intentionally on the right. The old bottom "Particles" label is removed.
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.End.X + 8.0f, graphRect.Position.Y + graphRect.Size.Y * 0.5f), RainEnergyGraphYAxis, HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, new Color(0.75f, 0.75f, 0.75f));

		Color textColor = new Color(0.65f, 0.65f, 0.65f);
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.Position.X - 5.0f, graphRect.End.Y + 14.0f), "0", HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, textColor);
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.Position.X + graphRect.Size.X * 0.5f - 15.0f, graphRect.End.Y + 14.0f), FormatParticleCount(particleEnergyMaxParticles * 0.5f), HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, textColor);
		DrawString(ThemeDB.FallbackFont, new Vector2(graphRect.End.X - 30.0f, graphRect.End.Y + 14.0f), FormatParticleCount(particleEnergyMaxParticles), HorizontalAlignment.Left, -1, UiSettings.FontSizeSmall, textColor);
